...
$string['autosaveconversioninterval'] = 'Auto-save to full delay';
$string['autosaveconversioninterval_desc'] = 'When auto-save is enabled this feature will convert an auto-saved change in the response to a question to a normal save when the time since the last normal save has exceeded this time interval. This will result in a snapshot of the students progress being captured while they are attempting the question. WARNING: This features results in more data being retained in the database and can affect performance if it is set very low. It is mostly useful for long running questions like Essay type etc. Setting the interval to 0 turns off this feature';
$string['autosaveconversionoutofsequencewarning'] = 'You can only have one copy of a quiz open at a time. Please close all other quiz windows, make note of your responses and reload this page. Some progress may be lost.';
$string['autosaveconversionenabledinvaliddata'] = 'Invalid data in auto-save conversion, possible attempt to bypass form';
$string['responsereplayavailable'] = 'Response replay available';
$string['responsereplayavailable_desc'] = 'Allows previous responses to questions to be replayed if supported and enabled';
$string['responsereplaydefault'] = 'Response replay enabled default';
$string['responsereplaydefault_desc'] = 'If response replay is enabled by default';
$string['responsereplayenabled'] = 'Undo';
$string['responsereplayenabled_help'] = 'Gives students the ability to replay a previous response, essentially provides undo functionality';
$string['quiz:setresponsereplay'] = 'Configure response replay';
$string['responsereplayenabledinvaliddata'] = 'Invalid data response rollback, possible attempt to bypass form';
